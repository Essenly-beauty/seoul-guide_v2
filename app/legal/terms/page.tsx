...
export const metadata: Metadata = { title: "Terms of Service — Essenly" };

// NOTE: Draft copy. Must pass legal review before public launch.
const SECTIONS = [
  { heading: "Who we are", body: [
    "Essenly is a curation and booking companion for beauty experiences in Seoul — salons, spas, head spas, skin clinics, and K-beauty shopping. We connect you with independent venues; we do not operate them.",
  ]},
  ...
  { heading: "Your content", body: [
    "Reviews and photos you post must reflect your genuine experience. By posting, you grant Essenly a non-exclusive license to display that content in the app. We may remove content that is fraudulent, offensive, or unrelated.",
  ]},
  { heading: "Liability", body: [
    "Services are provided \"as is\". To the extent permitted by law, Essenly is not liable for the acts or omissions of venues, nor for indirect damages arising from use of the app.",
  ]},
...
export default function TermsPage() {
  return (
    <LegalArticle
      ...
      updated="Jul 5, 2026"
      intro="These terms apply when you use Essenly to discover, book, or review beauty experiences in Seoul. By using the app you agree to them."
      sections={SECTIONS}
    />
  );
}
