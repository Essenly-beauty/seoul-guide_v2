...
// rebuilds must not lose the Kakao-sourced opening hours (2026-08-23) —
// scripts/backfill-hours.mjs owns scripts/lib/hours-overrides.json
// English-first titles: a rebuild must not put the Korean branch suffix back
// into the English name (owner decision 2026-08-23).
let englishized = 0;
...
console.log(`titles englishized: ${englishized}`);
